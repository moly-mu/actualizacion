    ...
    <div className="flex">
      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center space-y-4">
          <h2
            className="text-2xl font-extrabold cursor-pointer relative z-10 text-center"
          >
            <span className="text-yellow-500 inline-block transition-all duration-300 ease-in-out transform hover:scale-150 ">U</span>
            <span className="text-blue-500 inline-block transition-all duration-300 ease-in-out transform hover:scale-150 ">D</span>
            <span className="text-red-500 inline-block transition-all duration-300 ease-in-out transform hover:scale-150 ">C</span>
            <span className="text-black text-2xl"> TALENTO</span>
          </h2>
