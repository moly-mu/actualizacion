...
const SidebarEmpresa = ({ onViewChange, onLogout }) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire({
          ...
          navigate("/login-empresa"); // Redirige al login
        });
      }
    });
  };
      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center space-y-4">
          ...
          <p className="text-sm text-gray-600 text-center">
            Conectando oportunidades laborales con talento de alto nivel
          </p>
        </div>
        ...
        <div className="space-y-4">
          <ul>
            {/* Mover el Perfil arriba */}
            <li>
              <button
                onClick={() => onViewChange("perfilEmpresa")}
            ...
            <li>
              <button
                onClick={() => onViewChange("crearOferta")}
                className="text-gray-600 hover:text-blue-500 transition duration-300 ease-in-out p-2 rounded-lg w-full text-left flex items-center"
              >
            ...
            <li>
              <button
                onClick={() => onViewChange("ofertasSubidas")}
                className="text-gray-600 hover:text-blue-500 transition duration-300 ease-in-out p-2 rounded-lg w-full text-left flex items-center"
              >
